...
type AuthClient interface {
	...
	RevokeAppSessions(ctx context.Context, in *RevokeAppSessionsRequest, opts ...grpc.CallOption) (*RevokeAppSessionsResponse, error)
...
func (c *authClient) RevokeAppSessions(ctx context.Context, in *RevokeAppSessionsRequest, opts ...grpc.CallOption) (*RevokeAppSessionsResponse, error) {
	out := new(RevokeAppSessionsResponse)
	err := c.cc.Invoke(ctx, "/auth.Auth/RevokeAppSessions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	RevokeAppSessions(context.Context, *RevokeAppSessionsRequest) (*RevokeAppSessionsResponse, error)
...
func (UnimplementedAuthServer) RevokeAppSessions(context.Context, *RevokeAppSessionsRequest) (*RevokeAppSessionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RevokeAppSessions not implemented")
}
...
func _Auth_RevokeAppSessions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeAppSessionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).RevokeAppSessions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/RevokeAppSessions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RevokeAppSessions(ctx, req.(*RevokeAppSessionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RevokeAppSessions",
			Handler:    _Auth_RevokeAppSessions_Handler,
		},
		{
