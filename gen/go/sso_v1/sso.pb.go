...
type OAuthRequest struct {
	...
	AccessToken string `protobuf:"bytes,2,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"` //Access token returned by the OAuth flow
	AppId       int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`                  //ID of the app that the user is logging in to
}
...
var file_sso_proto_rawDesc = []byte{
	...
	0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x22, 0x70, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	...
	0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x29, 0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64,
	...
	0x6e, 0x22, 0x70, 0x0a, 0x0d, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x61, 0x69, 0x6c, 0x22, 0x64, 0x0a, 0x0c, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75,
	...
	0x28, 0x05, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x32, 0xc3, 0x02, 0x0a, 0x04, 0x41, 0x75,
	...
	0x02, 0x13, 0x22, 0x0e, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x69, 0x73, 0x5f, 0x61, 0x64, 0x6d,
	...
	0x0b, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x6f, 0x61, 0x75, 0x74, 0x68, 0x3a, 0x01, 0x2a, 0x42,
...
var file_sso_proto_goTypes = []interface{}{
	...
	(*OAuthResponse)(nil),    // 6: auth.OAuthResponse
...
var file_sso_proto_depIdxs = []int32{
	...
	7, // 3: auth.Auth.OAuth:input_type -> auth.OAuthRequest
	...
	6, // 7: auth.Auth.OAuth:output_type -> auth.OAuthResponse
