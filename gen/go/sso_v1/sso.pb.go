...
type LoginResponse struct {
	...
	UserId   int64  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`    //ID of the user that was logged in
	Username string `protobuf:"bytes,3,opt,name=username,proto3" json:"username,omitempty"`               //Username of the user that was logged in
	Email    string `protobuf:"bytes,4,opt,name=email,proto3" json:"email,omitempty"`                     //Email of the user that was logged in
	Avatar   string `protobuf:"bytes,6,opt,name=avatar,proto3" json:"avatar,omitempty"`                   //Avatar of the user that was logged in
	IsAdmin  bool   `protobuf:"varint,7,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` //Whether the user that was logged in is an admin or not
}
...
type LogInWithGithubRequest struct {
	...
	Code string `protobuf:"bytes,1,opt,name=code,proto3" json:"code,omitempty"` //Code returned by the Github OAuth flow
}
...
func (x *OAuthResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *OAuthResponse) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *OAuthResponse) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
type OAuthRequest struct {
	...
	AccesToken string `protobuf:"bytes,2,opt,name=acces_token,json=accesToken,proto3" json:"acces_token,omitempty"` //Code returned by the OAuth flow
}
...
func (x *OAuthRequest) GetAccesToken() string {
	if x != nil {
		return x.AccesToken
	}
	return ""
...
var file_sso_proto_rawDesc = []byte{
	...
	0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x22, 0xa3, 0x01, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x22, 0x29, 0x0a, 0x0e,
	...
	0x41, 0x64, 0x6d, 0x69, 0x6e, 0x22, 0x2c, 0x0a, 0x16, 0x4c, 0x6f, 0x67, 0x49, 0x6e, 0x57, 0x69,
	0x74, 0x68, 0x47, 0x69, 0x74, 0x68, 0x75, 0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63,
	0x6f, 0x64, 0x65, 0x22, 0x70, 0x0a, 0x0d, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70,
	...
	0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x4b, 0x0a, 0x0c, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65,
	...
	0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x63, 0x63, 0x65, 0x73, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x32, 0xcf, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x57, 0x0a, 0x08, 0x52,
	...
	0x72, 0x3a, 0x01, 0x2a, 0x12, 0x4b, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x12, 0x2e,
	...
	0x16, 0x22, 0x11, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x69, 0x73, 0x5f, 0x61,
	0x64, 0x6d, 0x69, 0x6e, 0x3a, 0x01, 0x2a, 0x12, 0x4b, 0x0a, 0x05, 0x4f, 0x41, 0x75, 0x74, 0x68,
	0x12, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x4f, 0x41, 0x75, 0x74,
	0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x19, 0x82, 0xd3, 0xe4, 0x93, 0x02,
	0x13, 0x22, 0x0e, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x6f, 0x61, 0x75, 0x74,
	0x68, 0x3a, 0x01, 0x2a, 0x42, 0x17, 0x5a, 0x15, 0x66, 0x75, 0x72, 0x6d, 0x61, 0x6e, 0x6f, 0x76,
...
var file_sso_proto_goTypes = []interface{}{
	...
	(*LogInWithGithubRequest)(nil), // 6: auth.LogInWithGithubRequest
	(*OAuthResponse)(nil),          // 7: auth.OAuthResponse
	(*OAuthRequest)(nil),           // 8: auth.OAuthRequest
}
var file_sso_proto_depIdxs = []int32{
	...
	8, // 3: auth.Auth.OAuth:input_type -> auth.OAuthRequest
	...
	7, // 7: auth.Auth.OAuth:output_type -> auth.OAuthResponse
...
func file_sso_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sso_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LogInWithGithubRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
